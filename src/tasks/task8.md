...
public abstract class Combinations {
    ...
    public abstract void delete_combination(AbstractFigure combination);
    ...
    // предусловие: на поле есть комбинации
    public abstract AbstractFigure[] get_combinations();

    // получить очки за комбинацию
    // предусловие: на поле есть комбинации
    public abstract long getScore(AbstractFigure combination);
